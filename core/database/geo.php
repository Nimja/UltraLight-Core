 ...
 *
 * Requires GeoIP2, the database for it and MaxMind DB reader to be installed.
 */
class Geo
{
     ...
     *
     * http://dev.maxmind.com/geoip/geoip2
     *
     * @var \GeoIp2\Database\Reader
     */
    private $_geo;
    /**
     * Use city DB or country DB.
     * @var boolean
     */
    private $_useCity = true;
    /**
     * The locale for getting the name.
     * @var type
     */
    private $_locale = 'en';

    /**
     * Constructor; switch between country/city database.
     * @param boolean $useCity
     */
    public function __construct($useCity = false)
    {
    ...
    /**
     * Actually find the given IP in ipv4 or ipv6.
     * @param string $ip
     * @return string
     */
